...
values(2,to_date('2022-03-12'),to_date('2022-03-17'),seq_bookdetail_bdseq.nextval,3,1301);
 ...
 insert into hotelqna (qnaseq, title, content, id) 
...
select * from book_view
select hotelnum from book_view where checkout > to_date('2023-05-09','yyyy-mm-dd') 
	and checkin < to_date('2023-05-13','yyyy-mm-dd') and kind = 'Deluxe';